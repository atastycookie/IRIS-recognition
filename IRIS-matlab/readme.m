...
% Функции
%
% Сделать фотографию глаза:                       Открывается превью камеры и производится снимок глаза
%                                                 для последующего его использования для аутентификации.
%
% Выбрать файл:                                   Выбрать файл из папки. 
%
% Добавить изображение в базу данных:                Выбранное изображение
% будет добавлено в базу данных к нужному пользователя. Если дользователь
% еще не зарегистрирован, следует зарегистрироваться.
%
